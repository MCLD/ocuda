namespace Ocuda.Utility.Keys
{
    public struct Cache
    {
        ...
        /// </summary>
        public static readonly string OpsUsername = "ocuda.ops.auth.{0}.username";
        /// <summary>
        /// The return URL once the user is authenticated, replace {0} with the user's identifier.
        /// </summary>
        public static readonly string OpsReturn = "ocuda.ops.auth.{0}.return";
        /// <summary>
        ...
        /// </summary>
        public static readonly string OpsGroup = "ocuda.ops.auth.{0}.group{1}";
    }
}
