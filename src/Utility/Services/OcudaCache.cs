...
{
    public class OcudaCache : Interfaces.IOcudaCache
    {
        private readonly IDistributedCache _cache;
        private readonly ILogger<OcudaCache> _logger;

        public OcudaCache(ILogger<OcudaCache> logger, IDistributedCache cache)
        {
