...
namespace Ocuda.Ops.Data
{
        ...
        : Utility.Data.DbContextBase, IMigratableContext, IDataProtectionKeyContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SectionLinkLibrary>()
                .HasKey(_ => new { _.SectionId, _.LinkLibraryId });
            modelBuilder.Entity<SectionFileLibrary>()
                .HasKey(_ => new { _.SectionId, _.FileLibraryId });
        }
