namespace Ocuda.i18n.Keys
{
    ...
    public static class Promenade
    {
        ...
        public const string EmployeeCardAddressInfo = "please do not enter your work address here";
        public const string EmployeeCardAddressLabel = "Home Address";
        public const string EmployeeCardEmployeeLabel = "Employee Information";
        public const string EmployeeCardPersonalLabel = "Personal Information";
        public const string EmployeeCardRenewInfo = "Please select yes if you already have a library card!";
        public const string EmployeeCardRenewLabel = "Renew an existing Account?";
        public const string EmployeeCardThankYou = "Thank you for submitting your request!";
        ...
        public const string PromptLibraryCardPlease = "Please enter your library card number";
