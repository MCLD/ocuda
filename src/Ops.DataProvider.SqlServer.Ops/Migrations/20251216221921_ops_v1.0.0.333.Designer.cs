...
namespace Ocuda.Ops.DataProvider.SqlServer.Ops.Migrations
{
    ...
    [Migration("20251216221921_ops_v1.0.0.333")]
    partial class ops_v100333
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ocuda.Ops.Models.Entities.ApiKey", b =>
                {
                    ...
                    b.Property<int>("RepresentsUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ocuda.Ops.Models.Entities.IdentityProvider", b =>
                {
                    ...
                    b.Property<string>("AssertionConsumerLink")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("EndpointLink")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ocuda.Ops.Models.Entities.ApiKey", b =>
                {
                    ...
                    b.HasOne("Ocuda.Ops.Models.Entities.User", "RepresentsUser")
                        .WithMany()
                        .HasForeignKey("RepresentsUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
