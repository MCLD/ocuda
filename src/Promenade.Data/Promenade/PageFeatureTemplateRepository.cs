...
namespace Ocuda.Promenade.Data.Promenade
{
    ...
    {
        public PageFeatureTemplateRepository(Repository<PromenadeContext> repositoryFacade,
            ILogger<PageFeatureTemplateRepository> logger) : base(repositoryFacade, logger)
        {
        }

        public async Task<PageFeatureTemplate> GetForPageLayoutAsync(int pageLayoutId)
        {
