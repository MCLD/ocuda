...
namespace Ocuda.SlideUploader
{
    internal class Program
    {
        ...
        protected static async Task Main(string[] args)
        {
            ...
            {
                Log.Fatal(ex,
                    "{Product} instance {Instance} v{Version} exited unexpectedly: {Message}",
                    Product,
                    instance,
                    version,
                    ex.Message);
        ...
        private static void VerifyOptions(SlideUploaderOptions options)
        {
            ...
            {
                issues.Add("Missing config: ApiKey - an API key generated by the software with privileges to upload slides");
            }
