...
namespace Ocuda.Promenade.Controllers
{
    ...
    public class LocationsController : BaseController<LocationsController>
    {
        ...
        [Route("{locationStub}/volunteer/[action]")]
        public IActionResult FormSubmissionSuccess(string locationStub, string volunteerType)
        {
            var viewModel = new FormSubmissionSuccessViewModel(locationStub, volunteerType);
